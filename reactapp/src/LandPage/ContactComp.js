                        ...
                        <div className="container-fluid py-5"> 
                            <div className="row align-items-stretch"> 
                                <div className="col-12"> 
                                    ...
                                    <p>Submit your details and we’ll contact you right away to discuss your needs in more detail.</p> 
                                    <div className="row"> 
                                    ...
                                    <form >
                                        ...
                                        <div className='form-group'>
                                            <label className='form-label'>Enter your organisation:</label>
                                        ...
                                        <div className='form-group'>
                                            ...
                                            <textarea type='text' name='cmessage' className='form-control'/>
                                        </div>
                                    ...
                                    <div className="col-md-4 contact-country-list mt-4 mt-md-0"> 
                                        <div className="contact-address location-item" id="chennaiLocation"> 
                                            <h3 className="mb-2">Chennai</h3> 
                                            <p>Beast Technologies Pvt., Ltd., H-3 IT Park, OldMaruvathur Road, Siruseri, Chennai – 603 103. India </p> 
                                            <p><a className="d-inline-block" href="tel:000">+91 472827180000 , </a><a classNam="d-inline-block" href="tel:+7480003">+91 4754880003</a></p> 
                                            <p><a href="mailto:talktous@beast.com">talktous@beast.com</a></p> 
                                        </div> 
                                        <div>
